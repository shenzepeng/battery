...
import com.example.battery.bo.FirstUserSentGovernment;
...
public class RsaTool {
    ...
    public static void main(String[] args)
    {
        ...
        // 公钥加密，私钥解密
        String enStr1 = RsaTool.encryptByPublicKey(JsonUtils.objectToJson(firstUserSentGovernment), publicKey);
